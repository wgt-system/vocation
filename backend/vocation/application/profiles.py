...
from vocation.domain.profiles import CandidateProfile, SearchProfile, validate_candidate_profile, validate_search_profile
...
class ProfileService:
    def __init__(self, repository: ProfileRepository, id_factory: Callable[[], str] = lambda: str(uuid4())):
    ...
    def create_search_profile(self, profile: SearchProfile) -> SearchProfile:
        ...
        validate_search_profile(created)
    ...
    def revise_search_profile(self, profile_id: str, profile: SearchProfile) -> SearchProfile:
        ...
        validate_search_profile(revised)
