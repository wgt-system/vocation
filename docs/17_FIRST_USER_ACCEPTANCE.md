...
This describes implementation, not the accepted final information architecture. The manual pass has since rejected parts of that presentation; see `18_MANUAL_PRODUCT_ACCEPTANCE.md` and #45.
...
Focused blockers are tracked in #45–#52. Detailed product direction is in `18_MANUAL_PRODUCT_ACCEPTANCE.md`.
